    ...
    <div className="projects">
      ...
      <div class="cards">
        ...
        <div className="card snake">
          <img src={Snake} alt="" />
            <div className="card__content">
                <p className="card__title"><span class="code">&lt;</span>Snake Game<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card calculator">
          ...
          <div className="card__content">
              <p className="card__title"><span class="code">&lt;</span>Calculator App<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card cinemareserve">
          ...
          <div className="card__content">
              <p className="card__title"><span class="code">&lt;</span>Cinema Reserve App<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card hangman">
          <img src={Hangman} alt="" />
          <div className="card__content">
              <p className="card__title"><span class="code">&lt;</span>Hangman Game<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card quotemachine">
          ...
          <div className="card__content">
              <p className="card__title"><span class="code">&lt;</span>Quota Machine App<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card vacantion">
          ...
          <div className="card__content">
          <p className="card__title" style={{ fontSize: "1.3rem" }}><span class="code">&lt;</span>Vacation Destinations Wish List<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card budgetapp">
          <img src={Budgetapp} alt="" />
            <div className="card__content">
                <p className="card__title"><span class="code">&lt;</span>Budget App<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card healthcareapp">
          <img src={Healthcareapp} alt="" />
           <div className="card__content">
              <p className="card__title"><span class="code">&lt;</span>Healthcare App<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card imagegenerator">
          ...
          <div className="card__content">
              <p className="card__title"><span class="code">&lt;</span>AI Image Generator<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card littlelemon">
          <img src={Littlelemon} alt="" />
           <div className="card__content">
              <p className="card__title"><span class="code">&lt;</span>Little Lemon Website<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card portfolio">
          ...
          <div className="card__content">
              <p className="card__title"><span class="code">&lt;</span>Portfolio Website<span class="code">&#47;&gt;</span></p>
        ...
        <div className="card sevabeauty">
          ...
          <div className="card__content">
              <p className="card__title"style={{ fontSize: "1.8rem" }}><span class="code">&lt;</span>Beauty Salon Website<span class="code">&#47;&gt;</span></p>
